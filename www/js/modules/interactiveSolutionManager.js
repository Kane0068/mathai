// =================================================================================
//  İnteraktif Çözüm Yöneticisi - interactiveSolutionManager.js
//  Adım bazlı çoktan seçmeli çözüm sistemi
// =================================================================================
...
export class InteractiveSolutionManager {
    ...
    evaluateSelection(selectedOptionId) {
        ...
        if (selectedOption.isCorrect) {
            ...
            this.completedSteps.push({
                ...
                attemptsUsed: this.totalAttempts - (this.completedSteps.length > 0 ? 
                    this.attemptHistory.filter(a => a.step < this.currentStep).length : 0)
            });
    ...
    getCompletionStats() {
        ...
        return {
            ...
            maxAttempts: this.maxAttempts,
            successRate: this.totalSteps > 0 ? (this.completedSteps.length / this.totalAttempts) * 100 : 0,
    ...
    calculatePerformance() {
        const successRate = this.totalSteps > 0 ? (this.totalSteps / this.totalAttempts) * 100 : 0;
        const efficiencyRate = this.maxAttempts > 0 ? ((this.maxAttempts - this.totalAttempts + this.totalSteps) / this.maxAttempts) * 100 : 0;
